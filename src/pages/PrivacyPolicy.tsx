...
import privacyBg from "@/assets/images/68d58498cd278adf77c2fcb0_package-image5.webp";
        ...
        <div className="min-h-screen bg-background">
            ...
            >
                ...
                <div className="container-px pt-32 pb-16 md:pt-48 md:pb-24">
                    <Reveal>
                        <div className="flex items-center gap-2 text-white font-bold tracking-wider uppercase text-[14px] mb-4">
                        ...
                        <p className="text-xl font-semibold text-white/90 font-light max-w-3xl leading-relaxed">
                            At Maitry Holidays, we are committed to protecting your personal information and being transparent about how we handle your data.
                        </p>
                    </Reveal>
                </div>
                    ...
                    <div className="relative overflow-hidden rounded-[2.5rem] bg-white p-8 md:p-12 shadow-card border border-primary/20">
                        <div className="flex flex-col gap-12">
                            ...
                            <div className="flex flex-col md:flex-row gap-8 items-start">
                                ...
                                <div>
                                    <h2 className="text-2xl font-semibold text-foreground mb-4">Technical & Physical Security</h2>
                                    <p className="text-[16px] md:text-[18px] text-muted-foreground leading-relaxed font-light mb-6">
                            ...
                            <div className="text-center">
                                <h2 className="text-2xl font-semibold text-foreground mb-4">Additional Questions?</h2>
                                <p className="text-[16px] md:text-[18px] text-muted-foreground font-light mb-6 max-w-2xl mx-auto">
